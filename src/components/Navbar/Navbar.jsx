...
//                     <Offcanvas.Title id="menuLateralLabel" className='fs-3'>Menu</Offcanvas.Title>
//                 </Offcanvas.Header>
...
//                             <a className="nav-link" href="#login" onClick={handleClose}>Login</a>
//                         </li>
//                     </ul>
//                 </Offcanvas.Body>
//             </Offcanvas>
...
import { useState } from 'react';
import { Navbar as BootstrapNavbar, Offcanvas } from 'react-bootstrap';
// 1. IMPORTAR O LINK DO REACT-ROUTER-DOM
